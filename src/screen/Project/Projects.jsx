    ...
    <>
      <div className="pt-main" id={id}>
       <Swiper
        ...
        >
          <SwiperSlide>
        <div className="title" data-aos="fade-down-right" data-aos-duration="1000">
          <span>
            <b>Recent</b> Projects
          </span>
        </div>
...
<div className="row-btn1">
        ...
        <img src="https://res.cloudinary.com/dkg6aexz0/image/upload/v1669883046/projects_recent_r1ulcf.png" className="img"/>
          </div>
            </div>
          </SwiperSlide>
          <SwiperSlide>
        ...
        <div className="pt-pic" data-aos="zoom-in-right" data-aos-duration="1000">
        <img src="https://res.cloudinary.com/dkg6aexz0/image/upload/v1670487274/Group_2_rokbhe.png" className="img1"/>
          </div>
            </div>
          </SwiperSlide>
           </Swiper>
